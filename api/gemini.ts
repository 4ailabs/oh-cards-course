export default async function handler(req: any, res: any) {
  ...
  try {
    const response = await fetch('https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash-preview-04-17:generateContent?key=' + process.env.GEMINI_API_KEY, {
      method: 'POST',
